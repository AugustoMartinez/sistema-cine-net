...
public class ConfirmarReserva extends javax.swing.JFrame {
    ...
    private void btnReservaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReservaMousePressed
        ...
        Ticket ticket=new Ticket(funcion.getPelicula().getNombre(), numTicket.toString(), seleccionarTipo(), format.format(funcion.getDia()), funcion.getHorario().getHorario(), agregarButacas(), generarCosto().toString(), funcion.getSala().getNombre());
